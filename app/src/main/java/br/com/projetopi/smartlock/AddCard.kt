...
class AddCard : Fragment() {
    ...
    override fun onCreateView(
        ...
        val editTexts = listOf(binding.etNumeroCartao, binding.etCVV, binding.etData, binding.etNomeTitular)
        val textLayouts = listOf(binding.tlNumeroCartao, binding.tlCVV, binding.tlData, binding.tlNomeTitular)
        ...
        binding.btnAdicionar.setOnClickListener{
            if(isFilled()) {
                ...
                showFieldErrors()
                Snackbar.make(binding.btnAdicionar, "Preencha todos os campos corretamente", Snackbar.LENGTH_LONG ).show()
            }
        }
        return binding.root
    }
    ...
    private fun isFilled(): Boolean {
        return !(binding.etNumeroCartao.text.toString().isEmpty() || binding.etCVV.text.toString().isEmpty() ||
                binding.etData.text.toString().isEmpty() || binding.etNomeTitular.text.toString().isEmpty())
    }
